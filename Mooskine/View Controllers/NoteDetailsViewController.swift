...
extension NoteDetailsViewController {
    /// Returns an array of toolbar items. Usado para configurar o controlador de view
    ...
    /// appears above the keyboard. Retornaremos com nossa
    ...
    @IBAction func cowTapped(sender: Any) {
        ...
        backgroundContext.perform {
            ...
            let cowText = Pathifier.makeMutableAttributedString(for: selectedText,
                                                                withFont: UIFont(name: "AvenirNext-Heavy", size: 56)!,
                                                                withPatternImage: #imageLiteral(resourceName: "texture-cow"))
...
extension NoteDetailsViewController {
    ...
    func addSaveNotificationObserver() {
        removeSaveNotificationObserver()
        saveObserverToken = NotificationCenter.default.addObserver(forName: .NSManagedObjectContextObjectsDidChange,
                                                                   object: dataController.viewContext,
                                                                   queue: nil,
                                                                   using: handleSaveNotification(notification:))
    }
